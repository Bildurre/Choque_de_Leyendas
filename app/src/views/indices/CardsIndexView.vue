...
import CardsCatalog from '@/components/indices/CardsCatalog.vue'
import { useIndexPage } from '@/entities/indexPage'

// Índice público de cartas: CÁSCARA (canónica del locale DC-12 + SEO +
// IndexHeader). El interior — búsqueda, filtros de la barra derecha y
// rejilla con paginación doble — vive en CardsCatalog, compartido con el
...
<template>
  <main v-if="section" class="catalog-index cards-index">
    <IndexHeader :title="t(section.titleKey)" :subtitle="t('entitiesIntro.cards')" />
    <CardsCatalog :section="section" />
  </main>
</template>
