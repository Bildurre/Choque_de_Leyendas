...
// propias del juego (entitySections + herramientas + descargas), y agrupa
// bajo carpetas. Los grupos despliegan submenú al hover (chevron, mismo
// patrón que antes tenían las páginas con hijas); en móvil TODO lo del
