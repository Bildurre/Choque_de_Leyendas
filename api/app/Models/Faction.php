 ...
 * MediaLibrary (colección 'image'). SIN previews PNG: la web pública pinta
 * su tarjeta CSS en vivo (FactionCard) y no las necesita — la columna
 * preview_image queda sin uso y los PNG viejos, huérfanos en storage.
 */
